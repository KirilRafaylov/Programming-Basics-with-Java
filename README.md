...
In this repo you can find all the tasks from lectures and exercises from the following course __Programming Basics with Java__ held by www.softuni.bg and my solutions to all tasks. The following course introduces the basic statements and loops which are used in programming with Java.
